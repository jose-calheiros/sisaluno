...
<form  method="POST">
    <div class="nome"><p>Nome Completo: <br><input id="nome" type="text" name="nome"required></div> 
     ...
     <div class="siape"><p>Siape:<br> <input id="sp" type="text" name="siape"required/> </p></div>
     </div> 
    <div class="l2">
...
if ($idade > 120 || $idade < 18) {
 ...
 $sql = "INSERT INTO professor (nome,idade,datanascimento,endereco,estatus,cpf,siape) VALUES('$nome','$idade','$dt','$endereco','$estatus','$cpf','$siape')";
        ...
        if($sqlcombanco->execute())
            {
                ...
                alert(\"O Professor $nome foi cadastrado com sucesso!\");
            </script>";
